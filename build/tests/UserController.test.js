...
describe('UserController', function () {
    ...
    describe('login', function () {
        it('should return a JSON response with the access token', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userController.login(request, response, undefined)];
                    case 1:
                        _a.sent();
                        expect(bcrypt_1.compare).toHaveBeenCalledWith('test-password', 'hashed-password');
