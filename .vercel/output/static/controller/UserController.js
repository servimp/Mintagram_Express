...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.login = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, user, passwordMatch, accessToken, refreshToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        refreshToken = (0, jsonwebtoken_1.sign)({ username: username, id: user.id }, process.env.REFRESH_TOKEN_SECRET, { expiresIn: '7d' });
